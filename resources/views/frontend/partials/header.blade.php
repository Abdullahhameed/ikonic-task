<nav class="bg-zinc-50 border-gray-200 dark:bg-gray-900">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="{{ url('/') }}" class="flex items-center">
            <span class="self-center text-2xl font-semibold whitespace-nowrap text-gray-500 dark:text-white">Product Feedback</span>
        </a>
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            @if (Route::has('login'))
                <ul
                    class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-zinc-50 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                    @auth
                        <li>
